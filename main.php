    ...
    <div class="container" data-aos="zoom-out">
        ...
        <div class="row g-5">
            ...
            <div class="col-lg-8 col-md-6 content d-flex flex-column justify-content-center order-last order-md-first">
                <h3>Com o vasto conhecimento na questão</h3>
                <p>Temos especialistas que conhecem a rotina dos Cartórios, eles irão diretamente ao Cartório solicitar a sua documentação após receber o seu pedido.</p>
                <a class="cta-btn align-self-start" href="#">Veja mais</a>
            </div>
            ...
            <div class="col-xl-4 col-md-6" data-aos="zoom-in" data-aos-delay="200">
                <div class="service-item">
                    ...
                    <div class="details position-relative">
                        ...
                        <p>A certidão de casamento é o documento responsável por conferir aos cônjuges a comunhão plena entre ambos, que são realizados com base na igualdade de direitos e deveres.
                        </p>
                    </div>
                </div>
            </div><!-- End Service Item -->
            ...
            <div class="col-xl-4 col-md-6" data-aos="zoom-in" data-aos-delay="400">
                <div class="service-item">
                    ...
                    <div class="details position-relative">
                        ...
                        <p>A Certidão de Nascimento é o documento que comprova a cidadania de uma pessoa.</p>
                    </div>
                </div>
            </div><!-- End Service Item -->
